        ...
        <div class="container">
                ...
                <div class="row" style="margin-top:20px">
                    ...
                    <div  class="col-md-8" >
                        ...
                        <h4> <strong>FICHE DE TRANSFERT<br></strong></h4><h5 style="margin-left:30px">(Année <?php echo $d."-".$ab  ?>)</h5>
                    ...
                    <h5>N° de re&ccedil;u:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b><?php /*echo strtoupper("$num")*/ echo $num;?></b></h5><br>
                        ...
                        <h5>Date et lieu de naissance:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b><?php echo /*strtoupper("$r1->date_naiss"." "."à"." "."$lieu")*/ utf8_encode(stripslashes($naiss)). " à " .utf8_encode($lieu); ?> </b></h5><br>
                        ...
                        <h5>Niveau, d&eacute;partement et composante d'origine:&nbsp;&nbsp;&nbsp;<b><?php echo /*utf8_encode($r1->intit_niv)*/ utf8_encode($r1['intit_niv'])." en  "./*utf8_encode($r1->design_depart)*/utf8_encode($r1['design_depart'])."  -  "./*utf8_encode($r1->design_facult)utf8_encode*/utf8_encode($r1['design_facult']);?></b> </h5><br>
                        ...
                        <div style="margin-left:550px;margin-top:-20px;"><br>
                        <h5>...........,le............ </h5>
                        
                                <h5 style="margin-bottom:50px;margin-top:30px;">Signature de l'&eacute;tudiant:</h5>
                        </div><br><br>
                        <div class="border-top" style="margin-top:-30px"></div>
                        ...
                        <div class="row" style="margin-top:0px;margin-bottom:150px">
                            ...
                            <h6 align="center" style="margin-bottom:5px;margin-top:-50px"><strong>Visa du Directeur des Etudes et de la Scolarité</strong></h6>
