...
<section class="main-wrapper">
        ...
        <h5 align="left" style="margin-top:-100px;margin-bottom:130px;margin-left:-50px;color:#00b185;"> Fin de préinscription : <?php echo $dat['date_fin'];?></h5>
            ...
            <div class="text-center mb-5">
                ...
                <h1 class="soft-title-1">Compléter les choix </h1>
                <hr />
            </div>
            <table>
        ...
        <tr>
            ...
            <tr>
                <td>Nom : &nbsp;&nbsp;&nbsp;<b><?php echo ($data['nom']) ;?></b>
                &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                Prénom : &nbsp;&nbsp;&nbsp;<b><?php echo ($data['prenom'])  ;?></b></td>
            </tr>
            <tr border="1">
                <td>
            Date de naissance : &nbsp;&nbsp;&nbsp;<b><?php echo $data['date_naiss'] ;?></b> &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Lieu de naissance &nbsp;&nbsp;&nbsp;<b><?php echo ($data['lieu_naiss']) ;?>  &nbsp;&nbsp; &nbsp;&nbsp;</b>
                </td>
            </tr>
        ...
        <?php if($type == 1) { ?> 
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="form-group col-md-4">
                            ...
                            <select id="inputcomp" class="form-control" name="facult1" required>
                            <option value="" >---Choisir---</option>
                            <?php 
                            $pics = mysqli_query($link,"SELECT * FROM faculte where concours=0");
                           
                              while($data=mysqli_fetch_array($pics)){?>
																<option value="<?php echo utf8_encode($data['code_facult']);?>" data-concour="<?php echo utf8_encode($data['concours']);?>" ><?php echo utf8_encode($data['design_facult']);?></option>
           ...
           <br><br><br>
                          ...
                          <div class="form-group col-md-4">
                            ...
                            $pics = mysqli_query($link,"SELECT * FROM faculte where concours=0");
                              while($data=mysqli_fetch_array($pics)){?>
																<option value="<?php echo utf8_encode($data['code_facult']);?>" data-concour="<?php echo $data['concours'];?>"><?php echo utf8_encode($data['design_facult']);?></option>
                    ...
                    <div class="form-group col-md-4">
                            ...
                            <select id="inputcomp2" class="form-control" name="faculte3" required>
                            <option value="" >---Choisir---</option>
                            <?php 
    ...
    <div class="col-12">
        <form action="formu.php" method="POST">
            <div class="form-row">
                ...
                <div class="form-group col-md-4">
                    <label for="inputcomp1">Composante </label>
                    <select id="inputcomp1" class="form-control" name="faculte1" required>
                        <option value="" >---Choisir---</option>
