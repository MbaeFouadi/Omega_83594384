  ...
  if(mysqli_num_rows($bete)>0)
    {
      $message="Cet etudiant a déjà un reçu , vous pouvez plus faire un reçu";
        ...
        $req=mysqli_query($link,"INSERT INTO candidats (nin,nom,date_naiss,lieu_naiss,prenom,datePrescript,id_type,reference_id,traitant_recu,statut,serie,mention,annee,tel_mobile,sexe) values ('$n','$nom','$naiss','$lieu_naiss','$prenom','$dateJ','4','$reference_id','".$_SESSION['login']."','1','$serie','$ment','$annee','".$_POST['telm']."','$sexe')");
    }
    else{
