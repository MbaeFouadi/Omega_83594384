...
if($_SESSION['type']==1){
    ...
    AND (
     ...
     (id_type='1' OR id_type='4' OR id_type='5') AND id_ile='1'
    AND (
        candidats.choix1 ='".$_SESSION['dep']."'
        OR candidats.choix2 ='".$_SESSION['dep']."'
        OR candidats.choix3 ='".$_SESSION['dep']."'
...
if($_SESSION['ile']=="A"){
   /* $sqlist= mysqli_query($link,"SELECT * FROM candidats,note where
    ...
    AND (
        ...
        FROM candidats,users where 
        candidats.traitant_recu=users.login AND 
     (id_type='1' OR id_type='4' OR id_type='5') AND id_ile='2'
    AND (
        candidats.choix1 ='".$_SESSION['dep']."'
        OR candidats.choix2 ='".$_SESSION['dep']."'
        OR candidats.choix3 ='".$_SESSION['dep']."'
...
if($_SESSION['ile']=="M"){
    ...
    AND (
        ...
        FROM candidats,users where 
        candidats.traitant_recu=users.login AND 
     (id_type='1' OR id_type='4' OR id_type='5') AND id_ile='3'
    AND (
        candidats.choix1 ='".$_SESSION['dep']."'
        OR candidats.choix2 ='".$_SESSION['dep']."'
        OR candidats.choix3 ='".$_SESSION['dep']."'
...
if($_SESSION['type']==4){
    ...
    AND (
       ...
       /* $sqlist= mysqli_query($link,"SELECT * FROM candidats where
    id_type='3'
    AND traitant_recu != 'anjouan' 
    AND traitant_recu != 'moheli' 
    AND (
...
?>
        ...
        <h5 align="right" style="color:#00b185;"> <strong><?php echo  $_SESSION['libelle']." ".$_SESSION['ile']; ?></strong></h5>
        ...
        <h5 align="left" style="margin-top:-100px;margin-bottom:130px;margin-left:-60px;color:#00b185;"> Fin de préinscription : <?php echo $d['date_fin'];?></h5>
                    ...
                    <table class="table table-striped table-bordered tableexcel" id="tablexcel">
                        <thead class="thead-dark">
                                ...
                                <tr>
                                    ...
                                    <!-- <th scope="col">Moyenne Mathématique</th>
                                    <th scope="col">Moyenne Physique</th>  -->
                             ...
                             <!-- <?php  //}
                              ...
                              // if(GI=="RE" ||  GI=="REm" ||  GI=="REp" ||  GI=="Com" ||  GI=="G1"  ||  GI=="IE"  ||  GI=="SF"){  ?>
                                    <tr>
                                    ...
                                    <th scope="col">Date de naissance</th>
                                    <th scope="col">Lieu de naissance</th>
                                    <th scope="col">Moyenne Français</th>
                                    <th scope="col">Moyenne Mathématique</th>
                                    <th scope="col">Options</th>
                             ...
                             <?php  //}
                               ...
                               //if(GI=="ECT"){  ?>
                                    ...
                                    <th scope="col">Lieu de naissance</th>
                                    <th scope="col">Moyenne Français</th>
                                    <th scope="col">Moyenne Anglais</th>
                                    <th scope="col">Moyenne Arabe</th>
                                    <th scope="col">Options</th>
                             ...
                             <?php // }
                               ...
                               //if(GI=="STQ"){  ?>
                                    ...
                                    <th scope="col">Date de naissance</th>
                                    <th scope="col">Lieu de naissance</th>
                                    <th scope="col">Moyenne Statistique</th>
                            ...
                            while($datlist = mysqli_fetch_array($sqlist)){
                                ...
                                // $fr_s=$datlist['francais_sec'];
                                // $fr_p=$datlist['francais_pre'];
                                // $fr_t=$datlist['francais_tle'];
                                // $fr_b=$datlist['francais_bac'];
                                // $fr_moy=($fr_s+$fr_p+$fr_t+$fr_b)/4;
                                
                                // $ph_s=$datlist['physique_sec'];
                                // $ph_p=$datlist['physique_pre'];
                                // $ph_t=$datlist['physique_tle'];
                                // $ph_b=$datlist['physique_bac'];
                                // $phy_moy=($ph_s+$ph_p+$ph_t+$ph_b)/4;
                                
                                // $math_s=$datlist['mathematique_sec'];
                                // $math_p=$datlist['mathematique_pre'];
                                // $math_t=$datlist['mathematique_tle'];
                                // $math_b=$datlist['mathematique_bac'];
                                // $math_moy=($math_s+$math_p+$math_t+$math_b)/4;
            ...
            elseif($_SESSION['type']==4 || $_SESSION['type']==5){?>
                <div class="row">
                <div class="col-12">
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered tableexcel" id="tableexcel">
                            ...
                            <tbody>
                                <?php
                                $i=1;
                                while($dat=mysqli_fetch_array($sqlist1)){
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?=$dat['num_recu']?></td>
                                            <td><?=$dat['nin']?></td>
                                            <td><?= utf8_encode($dat['nom'])?></td>
                                            <td><?= utf8_encode($dat['prenom'])?></td>
                                            <td><?=$dat['date_naiss']?></td>
                                            <td><?= utf8_encode($dat['lieu_naiss'])?></td>
