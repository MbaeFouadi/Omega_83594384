                    ...
                    <table class="table table-striped table-bordered tableexcel" id="tablexcel">
                        <thead class="thead-dark">
                            ...
                            while($datlist = mysqli_fetch_array($sqlist)){
                                ...
                                // $ara_s=$datlist['arabe_sec'];
                                // $ara_p=$datlist['arabe_pre'];
                                // $ara_t=$datlist['arabe_tle'];
                                // $ara_b=$datlist['arabe_bac'];
                                // $ara_moy=($ara_s+$ara_p+$ara_t+$ara_b)/4;
                                
                                // $ang_s=$datlist['anglais_sec'];
                                // $ang_p=$datlist['anglais_pre'];
                                // $ang_t=$datlist['anglais_tle'];
                                // $ang_b=$datlist['anglais_bac'];
                                // $ang_moy=($ang_s+$ang_p+$ang_t+$ang_b)/4;
